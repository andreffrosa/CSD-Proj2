...
public class TestCond_REST {
	...
	private static String replica_id = "";
	
	private static Wallet newWallet() throws Exception {
		...
		replica_id = replica.launch(fileName, hash, className, r_args);
	...
	public static void main(String[] args) throws Exception {
		...
		// Test_cond_set
		test_cond_set(newWallet(), "SumInt", "SUM-1", 10, 5, "OPI", "OPI-1", 3, 25);
		test_cond_set(newWallet(), "SumInt", "SUM-1", 5, 10, "OPI", "OPI-1", 3, 25);
		test_cond_set(newWallet(), "OPI", "OPI-1", 10, 5, "SumInt", "SUM-1", 3, 25);
		test_cond_set(newWallet(), "OPI", "OPI-1", 5, 10, "SumInt", "SUM-1", 3, 25);
		test_cond_set(newWallet(), "wallet", pubKey, 10, 5, "SumInt", "SUM-1", 3, 25);
		test_cond_set(newWallet(), "wallet", pubKey, 5, 10, "SumInt", "SUM-1", 3, 25);
		test_cond_set(newWallet(), "wallet", pubKey, 10, 5, "OPI", "OPI-1", 3, 25);
		test_cond_set(newWallet(), "wallet", pubKey, 5, 10, "OPI", "OPI-1", 3, 25);
		test_cond_set(newWallet(), "SumInt", "SUM-1", 10, 5, "wallet", pubKey, 3, 25);
		test_cond_set(newWallet(), "SumInt", "SUM-1", 5, 10, "wallet", pubKey, 3, 25);
		test_cond_set(newWallet(), "OPI", "OPI-1", 10, 5, "wallet", pubKey, 3, 25);
		test_cond_set(newWallet(), "OPI", "OPI-1", 5, 10, "wallet", pubKey, 3, 25);

		// Test_cond_add
		test_cond_add(newWallet(), "SumInt", "SUM-1", 10, 5, "OPI", "OPI-1", 3, 25);
		test_cond_add(newWallet(), "SumInt", "SUM-1", 5, 10, "OPI", "OPI-1", 3, 25);
		test_cond_add(newWallet(), "OPI", "OPI-1", 10, 5, "SumInt", "SUM-1", 3, 25);
		test_cond_add(newWallet(), "OPI", "OPI-1", 5, 10, "SumInt", "SUM-1", 3, 25);
		test_cond_add(newWallet(), "wallet", pubKey, 10, 5, "SumInt", "SUM-1", 3, 25);
		test_cond_add(newWallet(), "wallet", pubKey, 5, 10, "SumInt", "SUM-1", 3, 25);
		test_cond_add(newWallet(), "wallet", pubKey, 10, 5, "OPI", "OPI-1", 3, 25);
		test_cond_add(newWallet(), "wallet", pubKey, 5, 10, "OPI", "OPI-1", 3, 25);
		test_cond_add(newWallet(), "SumInt", "SUM-1", 10, 5, "wallet", pubKey, 3, 25);
		test_cond_add(newWallet(), "SumInt", "SUM-1", 5, 10, "wallet", pubKey, 3, 25);
		test_cond_add(newWallet(), "OPI", "OPI-1", 10, 5, "wallet", pubKey, 3, 25);
		test_cond_add(newWallet(), "OPI", "OPI-1", 5, 10, "wallet", pubKey, 3, 25);
		
		/////////////////////////////////////////////////////

		new ReplicaManagerRESTClient("CSD1819", "https://localhost:8030/").stop(replica_id);
	}
