...
public class ClientCertificateVerifier {
	...
	public SSLContext init(String server_ks, String server_ks_pwd, String server_ts, String server_ts_pwd) {

		List<X509Certificate> trustedCertificates = new ArrayList<>();

		try (InputStream ksIs = new FileInputStream(server_ks)) {

			KeyStore ks = JKS.load(server_ks, server_ks_pwd);
			KeyStore ts = JKS.load(server_ts, server_ts_pwd);
